...
class _option:
    ...
    e.g. Gain current states by using 'opt = Options.autoCheckUnitGate',
    'Options.autoCheckUnitGate = False' is used to close it.\n
    \n
    ...
    \n
    :option: autoCheckUnitGate [default: True]\n
...
class SingleQubitGate(SingleQubitOperation):
    ...
    \n
    If Options.autoCheckUnitGate is true, after initialized or modified, gate
